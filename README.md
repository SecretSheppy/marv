...
| [go-mutesting](https://github.com/zimmski/go-mutesting)                      | Go         |   ⚠️    |              | `loop/range_break` mutants from [avito-tech fork](https://github.com/avito-tech/go-mutesting) never seem to be in the correct place.                       |
